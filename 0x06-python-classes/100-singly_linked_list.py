...
class Node:
    ...
    @property
    def next_node(self):
        """setting the next_node of the Node."""
...
class SinglyLinkedList:
    """Representng a singly-linked list."""
    ...
    def sorted_insert(self, value):
        ...
        node is insertd into list at the correct
    ...
    def __str__(self):
        """Defining the print() representtion of a SinglyLinkedList."""
        values = []
        tmp = self.__head
